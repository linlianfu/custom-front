  ...
  <div>
    <div style="max-width: 1000px;margin: 10px auto">
      <el-table ref="table" style="width: 100%;"
        ...
        <el-table-column prop="storeName" label="店铺名称" width="160px" show-overflow-tooltip/>
        <el-table-column prop="legalPerson" label="法人"/>
        <el-table-column prop="businessLicense" label="营业执照" width="160px" show-overflow-tooltip/>
